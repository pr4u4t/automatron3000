...
public:
    ...
    void setupUi(MdiChild *SettingsDialog)
    {
        ...
        autoConnectCheckBox = new QCheckBox(additionalOptionsGroupBox);
        autoConnectCheckBox->setObjectName("autoConnectCheckBox");

        verticalLayout->addWidget(autoConnectCheckBox);
