...
//============================================================================
QByteArray CDockManager::getPerspective(const QString& UniquePrespectiveName) const
{
    return d->Perspectives.contains(UniquePrespectiveName) 
        ? d->Perspectives[UniquePrespectiveName] 
        : QByteArray();
}

//============================================================================
bool CDockManager::hasPerspective(const QString& UniquePrespectiveName) const
{
    return d->Perspectives.contains(UniquePrespectiveName);
}
