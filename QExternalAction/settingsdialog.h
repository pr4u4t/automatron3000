...
struct QExternalActionSettings : public PluginSettings {
...
public:
    ...
    QExternalActionSettings(const QSettings& settings, const QString& settingsPath)
    ...
    bool operator==(const QExternalActionSettings& other) const {
        return m_title == other.m_title &&
            m_buttonLabel == other.m_buttonLabel &&
            m_programPath == other.m_programPath &&
...
public:
    ...
    SettingsDialog(QWidget* parent, const QExternalAction* action);

    ~SettingsDialog();

    operator QExternalActionSettings() const;
...
private:
    QExternalActionSettings m_currentSettings;
