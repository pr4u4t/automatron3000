...
public:
    ...
    void setupUi(QWidget *QDataUI)
    {
        ...
        groupBox_3 = new QGroupBox(QDataUI);
        groupBox_3->setObjectName("groupBox_3");
        horizontalLayout_2 = new QHBoxLayout(groupBox_3);
        horizontalLayout_2->setObjectName("horizontalLayout_2");
        importCsvButton = new QPushButton(groupBox_3);
        ...
        importDirButton = new QPushButton(groupBox_3);
        ...
        exportCSVButton = new QPushButton(groupBox_3);
        ...
        unlockButton = new QPushButton(groupBox_3);
    ...
    void retranslateUi(QWidget *QDataUI)
    {
        ...
        groupBox_3->setTitle(QCoreApplication::translate("QDataUI", "Import/Export", nullptr));
